...
begin
    ...
    if v_check_sorozatszam = 1 then
        insert into laptopok
            (sorozatszam, tipus, gyarto, processzor, videokartya, ram, kepernyomeret,processzororajel)
        values
            (p_sorozatszam,p_tipus,v_gyarto_id,p_processzor,p_videokartya,p_ram,p_kepernyomeret,p_processzororajel);
